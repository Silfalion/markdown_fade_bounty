...
class CustomMarkdownBuilderConfiguration {
  final Widget Function(md.Element, Widget child, int index)? customBuilder;

  final void Function(md.Element element, int index)? onElementParsed;

  CustomMarkdownBuilderConfiguration(
      {required this.customBuilder, required this.onElementParsed});
}
...
abstract class MarkdownWidget extends StatefulWidget {
  ...
  const MarkdownWidget({
    ...
    this.customMarkdownBuilderConfiguration,
  });

  final CustomMarkdownBuilderConfiguration? customMarkdownBuilderConfiguration;
...
class _MarkdownWidgetState extends State<MarkdownWidget>
  ...
  void _parseMarkdown() {
    ...
    final MarkdownBuilder builder = MarkdownBuilder(
      ...
      customMarkdownBuilderConfiguration:
          widget.customMarkdownBuilderConfiguration,
    );
...
class MarkdownBody extends MarkdownWidget {
  ...
  const MarkdownBody({
    ...
    super.softLineBreak,
    super.customMarkdownBuilderConfiguration,
  });
